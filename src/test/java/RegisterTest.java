...
public class RegisterTest {
    ...
    public void successfulRegister() throws InterruptedException {
        ...
        try {
            ...
            registerPage.insertFirstName("Alex");
            registerPage.insertLastName("Albon");
            ...
            registerPage.insertUsername("alexalbon");
            registerPage.insertPassword("7894lola");
            registerPage.confirmPassword("7894lola");
